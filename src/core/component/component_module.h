...
//
// The exported C factory entry and the host/module handshake belong to
// COMPONENT-ABI. r1 defines only the interface that entry will return; nothing
// here loads, unloads or looks up a shared library.
